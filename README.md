...
- [SETUP_MAC.md](SETUP_MAC.md) — Mac
- [SETUP_WINDOWS.md](SETUP_WINDOWS.md) — Windows
...
| `model_client26.py` | Cloud AI client (Claude, Gemini) |
| `model_client_local26.py` | Local AI client (phi, gemma) |
| `web/app26.py` | Flask web server, all API routes |
| `web/image_gen26.py` | Image generation and Excel diagram |
...
| `SETUP_MAC.md` | Mac installation guide |
